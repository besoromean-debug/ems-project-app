...
app.use(helmet()); // Simplified helmet for general security
app.use(helmet({
...
app.post('/login', loginLimiter, async (req, res) => {
    ...
    try {
        ...
        if (!user) {
            ...
            return res.redirect('/login?error=' + encodeURIComponent("Invalid credentials. Please check your username and password."));
